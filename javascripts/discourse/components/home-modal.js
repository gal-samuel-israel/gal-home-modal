...
export default Component.extend({
  ...
  init() {
    ...
    .then((data) => {        
        ...
        localStorage.setItem("homeModalCPI", SHA1(data.user.avatar_template));
